#======此源码是基到zhangke3016修改,感谢zhangke3016提供===
#根据只支持白天与黑夜改成可扩展方案
#ChangeTheme夜间模式开源库
...
@Override
    protected void onCreate(Bundle savedInstanceState) {
    		//1. 在要立即切换效果的页面调用此方法  初始化方法要在super.onCreate方法之前调用 无需在Fragment中重复调用初始化方法
              ChangeModeController.getInstance().init(this,R.attr.class).setCurrentTheme(this);
			//在其他页面调用此方法  
        	//ChangeModeController.setCurrentTheme(this);
       ...
       //2. 设置切换
       //ChangeModeController.changeTheme(this, ChangeModeHelper.MODE_INDEX_ENUM.MODE_DAY.getIndex());
       //ChangeModeController.changeTheme(this, ChangeModeHelper.MODE_INDEX_ENUM.MODE_NIGHT.getIndex());
    }
...
@Override
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //2.设置切换夜间活日间模式
       // ChangeModeController.changeTheme(this, ChangeModeHelper.MODE_INDEX_ENUM.MODE_DAY.getIndex());//切换日间模式
       //ChangeModeController.changeTheme(this, ChangeModeHelper.MODE_INDEX_ENUM.MODE_NIGHT.getIndex());//切换夜间模式
    }
 @Override
    protected void onDestroy() {
        super.onDestroy();
...
##另：新增主题在 ChangeModeHelper修改,该类有具体的说明.就不细说# changeTheme
